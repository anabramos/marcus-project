...
const lekkersQueries = [
    ...
    },
    {
        ...
        fields: ['name', 'formatted_address', 'geometry'],
        contributors: 'Nimalka',
        description: "this probably seems like a very strange suggestion but the logic is actually quite brilliant (if I do say so myself). The Dutch (bless their hearts) and especially the office colleagues are very judgy and snooty about Starbucks so for the most part you don’t find them in there. Instead you find more North American people inside and you hear a lot more English white noise inside. I used to use Starbucks as my escape when the Dutch became too Dutch and when the office became too stifling. I found the inside atmosphere of Starbucks would calm me down enough and made me feel more at home. It was the closes culture to what I had grown up with in Dubai. I’d go in sometimes have a nice cry with my coffee and then come back to the office. I always knew id never ever run into any office colleagues in there. It was my safe space."
    },
    {
